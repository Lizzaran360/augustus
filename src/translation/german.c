...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_NO_SUPPLIER_DISTRIBUTION, "Der Kauf von Marktfrauen verteilt keine Güter"},
    ...
    {TR_BUILDING_CARAVANSERAI_POLICY_3, "Karawanen tragen 50% mehr Waren, aber ihre Geschwindigkeit ist um 15% reduziert."},
	...
	{TR_BUILDING_LIGHTHOUSE_POLICY_3, "Maritime Mengenpolitik: Handelsschiffe transportieren 50% mehr Waren, bewegen sich aber 15% langsamer." },
