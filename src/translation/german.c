...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GRAND_TEMPLE_CERES_BONUS_DESC, "Karrenschieber von Farmen bewegen sich 50% schneller"},
    ...
    {TR_WINDOW_BUILDING_DISTRIBUTION_CART_PUSHER_GETTING, "Der Wagenschieber ist auf dem Weg, um die Waren aus einem anderen Lager zu holen." },
