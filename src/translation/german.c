...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_GETTING_GRANARIES_GO_OFFROAD, "Wagenschieber von fordernden Silos können neben der Straße fahren"},
    {TR_CONFIG_GRANARIES_GET_DOUBLE, "Doppelte Kapazität für Wagenschieber fordernder Silos"},
    ...
    {TR_HOTKEY_ROTATE_BUILDING_BACK, "Gebäude zurück drehen"},
