...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_SHOW_WATER_STRUCTURE_RANGE_HOUSES, "Beim Bau von Häusern die Reichweite von Ziehbrunnen und Brunnen anzeigen"},
    ...
    {TR_BUILDING_CITY_MINT, "Städtische Münze" },
    {TR_BUILDING_CITY_MINT_DESC, "Hier wird Gold zu Münzen geprägt, diese füllen die städtische Schatzkammer." },
    {TR_BUILDING_CITY_MINT_DESC_ALTERNATIVE, "Hier werden die Münzen in Gold eingeschmolzen, das für den Bau von Denkmälern verwendet werden kann."},
    {TR_BUILDING_CITY_MINT_DESC_NO_PALACE, "Baut euren Anwesen damit die Münze auch euch persönlich bereichert." },
    {TR_BUILDING_CITY_MINT_DESC_PALACE, "Da ihr ein Anwesen habt, werden bekommt ihr extra Denarii für euren Geldbeutel." },
    {TR_BUILDING_CITY_MINT_FULL_EMPLOYEES, "Die lokale Münze hat alle Arbeiter die benötigt werden. Sie arbeitet auf hochtouren um neue Münzen zu prägen." },
    {TR_BUILDING_CITY_MINT_MANY_EMPLOYEES, "Die lokale Münze arbeitet nicht auf ihrer maximalen Kapazität. Das Prägen von Münzen ist daher weniger effizient." },
    {TR_BUILDING_CITY_MINT_HALF_EMPLOYEES, "Die lokale Münze is unterbesetzt. Das Prägen von Münzen braucht länger als nötig." },
    {TR_BUILDING_CITY_MINT_SOME_EMPLOYEES, "Es gibt nur wenige Arbeiter. Das Prägen von Münzen ist deswegen sehr langsam." },
    {TR_BUILDING_CITY_MINT_FEW_EMPLOYEES, "Mit einem Minimum an Arbeitern kommt das Prägen zum Erliegen. Diese Jahr werden fast keine Münzen geprägt." },
    {TR_BUILDING_CITY_MINT_NO_EMPLOYEES, "Die lokale Münze hat keine Arbeiter, die Münzprägung ist gestoppt." },
    {TR_BUILDING_CITY_MINT_NO_GOLD, "Dieses Gebäude braucht Gold, entweder von einem Warenhaus oder der Goldmine, um zu arbeiten." },
    {TR_BUILDING_CITY_MINT_STORED_GOLD, "Gelagertes Gold," },
    {TR_BUILDING_CITY_MINT_NO_SENATE, "Dieses Gebäude braucht einen aktiven Senat. Ohne den Senat können keine Münzen geprägt werden." },
    {TR_BUILDING_CITY_MINT_PHASE_1, "(Fundament)" },
    {TR_BUILDING_CITY_MINT_PHASE_1_TEXT, "Die Ingenieure arbeiten an dem Fundament." },
    ...
    {TR_CITY_WARNING_GOLD_NEEDED, "Dieses Gebäude braucht Gold" },
    ...
    {TR_EDITOR_FAVOUR_DISFAVOR, "verlorene Gunst wenn mehr Zeit benötigt wird" },
