...
static translation_string all_strings[] = {
    ...
    /* Menüs */
    {TR_AUTO_CYCLE_TEMPLES, "Autmatisch durchschalten"},
    ...
    {TR_HOTKEY_MOTHBALL_TOGGLE, "Stillegen" },
    ...
    {TR_HOTKEY_SHOW_OVERLAY_EFFICIENCY, "Effizientsoverlay" },
    ...
    {TR_HOTKEY_SHOW_OVERLAY_RISKS_NATIVE, "Eingeborenen Spezialkarte"},
    ...
    {TR_BUILDING_CONCRETE_MAKER_DESC, "Hier wird Sand zu Beton für den Bau von Monumenten gemischt."},
    ...
    {TR_BUILDING_CONCRETE_MAKER_MANY_EMPLOYEES, "Diese Werkstatt arbeitet unter ihrer maximalen Kapazität. Die Betonproduktion könnte mit mehr Arbeitern etwas effizienter sein."},
    {TR_BUILDING_CONCRETE_MAKER_HALF_EMPLOYEES, "Diese Werkstatt ist unterbesetzt. Die Produktion von Beton dauert länger, als sie sollte."},
    ...
    {TR_BUILDING_GOLD_MINE_DESC, "Baue Gold ab für den Handel oder um die lokale Münze zu versorgen und um Denarii zu prägen." },
    {TR_BUILDING_GOLD_MINE_FULL_EMPLOYEES, "Diese Mine hat alle Arbeiter die sie benötigt und die Produktion ist stabil." },
    {TR_BUILDING_GOLD_MINE_MANY_EMPLOYEES, "Diese Mine arbeitet unter ihrer maximalen Auslastung. Mit mehr Arbeitern wäre sie etwas effizienter." },
    {TR_BUILDING_GOLD_MINE_HALF_EMPLOYEES, "Diese Mine ist unterbesetzt. Die Produktion von Gold braucht länger als nötig ." },
    {TR_BUILDING_GOLD_MINE_SOME_EMPLOYEES, "Sehr wenige Leute arbeiten in dieser Mine. Die Förderung von Gold ist daher langsam." },
    ...
    {TR_BUILDING_DEPOT_DESC, "Das Karren-Depot sendet Karren aus, um die Waren je nach Auftrag zwischen den Lagerhäusern und Silos zu transportieren. Die Karren müssen nach jeder Lieferung zum Depot zurückkehren."},
    ...
    {TR_BUILDING_DEPOT_SOME_EMPLOYEES, "Dieses Depot hat nur wenige Arbeiter. Es dauert eine Weile, bis die Waren umgeladen werden." },
    {TR_BUILDING_DEPOT_HALF_EMPLOYEES, "Dieses Depot ist personell unterbesetzt. Die Waren werden daher nur langsam umgeschlagen." },
    {TR_BUILDING_DEPOT_MANY_EMPLOYEES, "Dieses Depot arbeitet unter seiner maximalen Kapazität. Mit mehr Arbeitern könnten die Waren etwas schneller umgeschlagen werden." },
    ...
    {TR_BUILDING_LARGE_MAUSOLEUM_CONSTRUCTION_DESC, "Für den Bau dieses Mausoleums werden in einem Lagerhaus gelagerte Materialien, Arbeiter aus einem Arbeitslager und Baumeister aus einer Baumeistergilde benötigt." },
    /* Gebäude - Leuchtturm */
    ...
    {TR_BUILDING_CITY_MINT_DESC, "Hier wird Gold zu Denarii geprägt, diese füllen die städtische Schatzkammer." },
    {TR_BUILDING_CITY_MINT_DESC_ALTERNATIVE, "Hier werden die Denarii in Gold eingeschmolzen, das für den Bau von Denkmälern verwendet werden kann."},
    {TR_BUILDING_CITY_MINT_DESC_NO_PALACE, "Baut euer Anwesen, damit die Münze auch euch persönlich bereichert." },
    {TR_BUILDING_CITY_MINT_DESC_PALACE, "Da ihr ein Anwesen habt, werden bekommt ihr extra Denarii für euren Geldbeutel." },
    {TR_BUILDING_CITY_MINT_FULL_EMPLOYEES, "Die Münze hat alle Arbeiter die benötigt werden. Sie arbeitet auf hochtouren um neue Denarii zu prägen." },
    {TR_BUILDING_CITY_MINT_MANY_EMPLOYEES, "Die Münze arbeitet nicht auf ihrer maximalen Kapazität. Das Prägen von Denarii ist daher weniger effizient." },
    {TR_BUILDING_CITY_MINT_HALF_EMPLOYEES, "Die Münze is unterbesetzt. Das Prägen von Denarii braucht länger als nötig." },
    {TR_BUILDING_CITY_MINT_SOME_EMPLOYEES, "Es gibt nur wenige Arbeiter. Das Prägen von Denarii ist deswegen sehr langsam." },
    {TR_BUILDING_CITY_MINT_FEW_EMPLOYEES, "Mit einem Minimum an Arbeitern kommt das Prägen zum Erliegen. Diese Jahr werden fast keine Denarii geprägt." },
    ...
    {TR_BUILDING_CITY_MINT_NO_SENATE, "Dieses Gebäude braucht einen aktiven Senat. Ohne den Senat können keine Denarii geprägt werden." },
    ...
    {TR_BUILDING_SAND_PIT_HALTED, "Ihr Handelsberater ordnete einen Stopp des Sandabbaus an."},
    {TR_BUILDING_SAND_PIT_NO_EMPLOYEES, "Diese Grube hat keine Arbeiter. Die Produktion wurde eingestellt."},
    {TR_BUILDING_SAND_PIT_FULL_EMPLOYEES, "Diese Grube hat alle Arbeiter, die sie braucht, und arbeitet mit Hochdruck daran, Sand abzubauen."},
    {TR_BUILDING_SAND_PIT_MANY_EMPLOYEES, "Diese Grube arbeitet unter ihrer maximalen Kapazität. Der Sandabbau könnte mit mehr Arbeitern etwas effizienter sein."},
    {TR_BUILDING_SAND_PIT_HALF_EMPLOYEES, "Diese Grube ist unterbesetzt. Es dauert länger, Sand abzubauen, als es sollte."},
    ...
    {TR_ACTION_TYPE_BUILDING_FORCE_COLLAPSE, "Gebäudeeinsturz erzwingen"},
    ...
    {TR_ACTION_TYPE_CHANGE_CUSTOM_VARIABLE, "Wert der eigenen Variablen ändern"},
    ...
    {TR_ACTION_TYPE_SHOW_CUSTOM_MESSAGE, "Eigene Nachricht anzeigen"},
    ...
    {TR_CONDITION_TYPE_CUSTOM_VARIABLE_CHECK, "Eigener Variablenwert"},
    ...
    {TR_EDITOR_CHOOSE_CUSTOM_EMPIRE, "Eigenes Imperium wählen"},
    ...
    {TR_EDITOR_CUSTOM_MESSAGES_EXPORT_FULL, "Eigene Nachrichten exportieren" },
    {TR_EDITOR_CUSTOM_MESSAGES_IMPORT_FULL, "Eigene Nachrichten importieren" },
    {TR_EDITOR_CUSTOM_MESSAGES_TITLE, "Eigene Nachrichten" },
    {TR_EDITOR_CUSTOM_VARIABLES_COUNT, "Maximal mögliche Variablen" },
    {TR_EDITOR_CUSTOM_VARIABLES_TITLE, "Eigene Variablen" },
    ...
    {TR_EDITOR_SCENARIO_EVENT_DELETED, "Gelöschtes Ereignis"},
    ...
    {TR_EDITOR_UNABLE_TO_LOAD_CUSTOM_MESSAGES_TITLE, "Unfähig eigene Nachrichten zu laden"},
    {TR_EDITOR_UNABLE_TO_LOAD_EMPIRE_MESSAGE, "Bitte kontrolliere augustus-log.txt in deinem Augustus Verzeichnis für Details."},
    {TR_EDITOR_UNABLE_TO_LOAD_EMPIRE_TITLE, "Eigenes Imperium kann nicht geladen werden"},
