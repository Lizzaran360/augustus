...
static translation_string all_strings[] = {
    ...
    {TR_TOOLTIP_OVERLAY_HEALTH_7, "HDie Gesundheit in diesem Haus ist sehr gut."},
    ...
    {TR_WINDOW_ADVISOR_MILITARY_INFANTRY, "Infanteriesoldat"},
    ...
    {TR_WINDOW_CUSTOM_CAMPAIGNS_NOT_IMPLEMENTED_TITLE, "Noch nicht implementiert." },
    {TR_WINDOW_CUSTOM_CAMPAIGNS_NOT_IMPLEMENTED_TEXT, "Die Unterstützung für eigene Kampagnen wurde noch nicht implementiert. Bitte prüfen Sie eine spätere Version."},
};
