...
static translation_string all_strings[] = {
    ...
    {TR_WINDOW_MISSION_LIST_BUTTON_BEGIN_SCENARIO, "Aufgabe beginnen"},
    {TR_WINDOW_MISSION_LIST_BUTTON_SCENARIO_SELECTION, "Aufgaben-Auswahl"},
    {TR_WINDOW_MISSION_LIST_SCENARIOS, "Aufgaben"},
    {TR_ORIGINAL_CAMPAIGN_FIRST_MISSION, "Aufgabe 1"},
    {TR_ORIGINAL_CAMPAIGN_SECOND_MISSION, "Brundisium: Aufgabe 2"},
