...
static translation_string all_strings[] = {
	...
	{TR_HOTKEY_ROTATE_BUILDING_BACK, "vorige Gebäudedrehung"},
    ...
    {TR_BUILDING_CARAVANSERAI_DESC, "Handelskarawanen finden hier Unterschlupf, um zu rasten und ihre Tiere zu füttern. Unterbrechungen des Landhandels dauern halb so lange."},
    ...
    {TR_BUILDING_CARAVANSERAI_POLICY_3, "Mengenpolitik: Handelskarawanen tragen 4 Waren mehr, verbrauchen aber 20% mehr Nahrung in der Karawanserei."},
    ...
    {TR_BUILDING_LIGHTHOUSE_POLICY_3, "Maritime Mengenpolitik: Handelsschiffe transportieren 4 Waren mehr, aber der Leuchtturm verbraucht 20% mehr Holz." },
    ...
    {TR_WARNING_VARIANT_TOGGLE, "Drücken Sie die Rotationstasten, um durch die Varianten dieses Gebäudes zu schalten"},
